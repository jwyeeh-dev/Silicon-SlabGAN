...
class Trainer:
    def __init__(self, width = 512, height= 1002, channels = 1, latent_size=100, epochs = 301, batch=32, checkpoint=50, model_type=-1):
        self.W = width
        self.H = height
        self.C = channels
        self.EPOCHS = epochs
        ...
        self.gan = WGAN(generator=self.generator.Generator, discriminator=self.discriminator.Discriminator)

        self.load_MNIST()

    def load_dataset(self,model_type=3):
